package com.gmail.subnokoii78.thunt.container;

import com.gmail.subnokoii78.thunt.events.EventDispatcher;
...
public class ItemButton {
    ...
    public @NotNull ItemButton name(@NotNull TextComponent component) {
        ...
        if (component.decoration(TextDecoration.ITALIC).equals(TextDecoration.State.NOT_SET)) {
            c = component.decoration(TextDecoration.ITALIC, false);
        }

        itemStackBuilder.customName(c);
        return this;
    }
